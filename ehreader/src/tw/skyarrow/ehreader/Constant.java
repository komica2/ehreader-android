...
public class Constant {
    ...
    public static final String API_URL_EX = "http://g.e-hentai.org/api.php";

    public static final String BASE_URL = "http://g.e-hentai.org";
    //public static final String BASE_URL_EX = "http://exhentai.org";
    public static final String BASE_URL_EX = "http://g.e-hentai.org";
    ...
    public static final String GALLERY_URL_EX = "http://g.e-hentai.org/g/%d/%s";
    ...
    public static final String PHOTO_URL_EX = "http://g.e-hentai.org/s/%s/%d-%d";
    ...
    public static final String IMAGE_SEARCH_URL_EX = "http://ul.e-hentai.org/image_lookup.php";
